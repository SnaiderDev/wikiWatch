    ...
    return (
        <footer className="flex-col gap-2">
            <div className="flex flex-wrap justify-center  items-center gap-4 p-4">
                ...
                <div>
                    <h2 className="font-subtitle text-2xl text-center text-[var(--color-primary)]">Participant</h2>
                    ...
                    <div className="text-center">----  <span className="text-[var(--color-primary)] font-bold">2026</span>  ----</div>

                </div>
                
            </div> 

            <div className="flex flex-wrap bg-black p-2 gap-3 justify-center items-center">
                <Icon><FaReact /></Icon>
